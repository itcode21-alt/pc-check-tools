...
const PARTS = {
  cpus: [
    { id: 'intel-core-ultra-9-285k',  query: '인텔 코어 울트라 9 285K CPU 프로세서', minPrice: 250000 },
    { id: 'intel-core-ultra-5-245k',  query: '인텔 코어 울트라 5 245K CPU 프로세서', minPrice: 150000 },
    { id: 'intel-core-i9-13900k',     query: '인텔 코어 i9-13900K CPU 프로세서',     minPrice: 120000 },
    { id: 'intel-core-i9-13900ks',    query: '인텔 코어 i9-13900KS CPU 프로세서',    minPrice: 140000 },
    { id: 'intel-core-i9-13900',      query: '인텔 코어 i9-13900 CPU 프로세서',      minPrice: 110000 },
    { id: 'intel-core-i7-13700k',     query: '인텔 코어 i7-13700K CPU 프로세서',     minPrice: 90000  },
    { id: 'intel-core-i7-13700',      query: '인텔 코어 i7-13700 CPU 프로세서',      minPrice: 80000  },
    { id: 'intel-core-i5-13600k',     query: '인텔 코어 i5-13600K CPU 프로세서',     minPrice: 70000  },
    { id: 'intel-core-i9-12900k',     query: '인텔 코어 i9-12900K CPU 프로세서',     minPrice: 90000  },
    { id: 'intel-core-i9-12900ks',    query: '인텔 코어 i9-12900KS CPU 프로세서',    minPrice: 100000 },
    { id: 'intel-core-i9-12900',      query: '인텔 코어 i9-12900 CPU 프로세서',      minPrice: 80000  },
    { id: 'intel-core-i7-12700k',     query: '인텔 코어 i7-12700K CPU 프로세서',     minPrice: 80000  },
    { id: 'intel-core-i7-12700',      query: '인텔 코어 i7-12700 CPU 프로세서',      minPrice: 70000  },
    { id: 'intel-core-i5-12600k',     query: '인텔 코어 i5-12600K CPU 프로세서',     minPrice: 60000  },
    { id: 'intel-core-i5-12600',      query: '인텔 코어 i5-12600 CPU 프로세서',      minPrice: 50000  },
    { id: 'intel-core-i3-14100f',     query: '인텔 코어 i3-14100F CPU 프로세서',     minPrice: 40000  },
    { id: 'intel-core-i3-14100',      query: '인텔 코어 i3-14100 CPU 프로세서',      minPrice: 45000  },
    { id: 'intel-core-i3-13100f',     query: '인텔 코어 i3-13100F CPU 프로세서',     minPrice: 35000  },
    { id: 'intel-core-i3-13100',      query: '인텔 코어 i3-13100 CPU 프로세서',      minPrice: 40000  },
    { id: 'amd-ryzen-9-9950x',        query: 'AMD 라이젠 9 9950X CPU 프로세서',      minPrice: 300000 },
    { id: 'amd-ryzen-9-9900x',        query: 'AMD 라이젠 9 9900X CPU 프로세서',      minPrice: 200000 },
    { id: 'amd-ryzen-9-7950x',        query: 'AMD 라이젠 9 7950X CPU 프로세서',      minPrice: 200000 },
    { id: 'amd-ryzen-9-7900x',        query: 'AMD 라이젠 9 7900X CPU 프로세서',      minPrice: 150000 },
    { id: 'amd-ryzen-9-7950x3d',      query: 'AMD 라이젠 9 7950X3D CPU 프로세서',    minPrice: 250000 },
    { id: 'amd-ryzen-9-7900x3d',      query: 'AMD 라이젠 9 7900X3D CPU 프로세서',    minPrice: 180000 },
    { id: 'amd-ryzen-7-7700x',        query: 'AMD 라이젠 7 7700X CPU 프로세서',      minPrice: 100000 },
    { id: 'amd-ryzen-5-7600x',        query: 'AMD 라이젠 5 7600X CPU 프로세서',      minPrice: 80000  },
    { id: 'amd-ryzen-5-7500f',        query: 'AMD 라이젠 5 7500F CPU 프로세서',      minPrice: 70000  },
    { id: 'amd-ryzen-5-8600g',        query: 'AMD 라이젠 5 8600G CPU 프로세서',      minPrice: 80000  },
    { id: 'amd-ryzen-5-8500g',        query: 'AMD 라이젠 5 8500G CPU 프로세서',      minPrice: 70000  },
  ],
  motherboards: [
  ...
  rams: [
    ...
    { id: 'samsung-ddr5-4800',                  query: '삼성 DDR5-4800 UDIMM 16GB 메모리 램',  minPrice: 20000 },
    { id: 'samsung-ddr5-5600',                  query: '삼성 DDR5-5600 UDIMM 16GB 메모리 램',  minPrice: 25000 },
    { id: 'teamgroup-elite-ddr5-4800',          query: '팀그룹 Elite DDR5 4800 메모리 램',      minPrice: 18000 },
    { id: 'teamgroup-vulcan-ddr5-5600',         query: '팀그룹 T-Force Vulcan DDR5 5600 램',   minPrice: 25000 },
    { id: 'teamgroup-vulcan-ddr5-6000',         query: '팀그룹 T-Force Vulcan DDR5 6000 램',   minPrice: 30000 },
    { id: 'gskill-ripjaws-s5-ddr5-5600',        query: 'G.Skill Ripjaws S5 DDR5 5600 램',      minPrice: 25000 },
    { id: 'kingston-fury-renegade-ddr5-6000',   query: '킹스턴 Fury Renegade DDR5 6000 램',    minPrice: 40000 },
  ],
  ssds: [
