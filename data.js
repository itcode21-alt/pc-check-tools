window.SITE_DATA = {
  ...
  errorCodes: [
    ...
    },
    {
      ...
      detailPage: "error-code-0xc004f050.html", faq: [{"q": "Home에 Pro 제품 키를 입력해도 되나요?", "a": "제품 키와 설치된 Windows 에디션이 맞아야 합니다. Home과 Pro가 다르면 키가 유효해도 0xC004F050이 발생할 수 있으므로 에디션을 먼저 확인하세요."}, {"q": "제품 키를 공개해도 되나요?", "a": "제품 키 전체는 공유하거나 게시하지 마세요. 구매 증빙과 키는 판매처 또는 Microsoft 공식 지원에만 제공하는 것이 안전합니다."}], decisionSteps: [{"condition": "에디션이 다를 때", "action": "Home용 키를 Pro에 넣었다면 오류가 계속됩니다. 에디션에 맞는 키를 구하거나, Windows Store에서 Pro 업그레이드를 정식 구매하세요."}, {"condition": "OEM 키를 다른 PC에 입력했을 때", "action": "OEM 키는 원래 제조사가 출하한 PC에서만 유효합니다. 해당 PC가 맞다면 Microsoft 지원에 문의하고, 다른 PC라면 리테일 키를 별도로 구매해야 합니다."}, {"condition": "단순 오타였을 때", "action": "재입력만으로 대부분 즉시 해결됩니다."}, {"condition": "모든 조건이 맞는데도 반복될 때", "action": "Microsoft 고객 지원(전화 활성화)으로 넘어가 오류 코드와 라이선스 채널을 함께 전달하세요."}],
      relatedSymptom: "windows-activation-error.html",
