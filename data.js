  ...
  errorCodes: [
    {
      ...
      detailPage: "error-code-0x800f0983.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x800F0983)로 반복 실패한다면 무한정 재시도하기보다 DISM 복구와 업데이트 캐시 초기화를 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "2026년 8월 패치와 관련이 있나요?", "a": "네, 2026년 8월 누적 업데이트(KB5121003 계열) 설치 이후 이 오류 신고가 늘었습니다. 구성 요소 저장소 손상이 주요 원인으로 지목되고 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x8007000d.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8007000D)로 반복 실패한다면 무한정 재시도하기보다 업데이트 캐시 초기화와 네트워크 상태 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "2026년 8월 패치와 관련이 있나요?", "a": "네, 2026년 8월 KB5120249 계열 업데이트에서 이 오류가 다수 보고되었습니다. 업데이트 파일 손상이나 캐시 문제가 주요 원인입니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0xc000021a.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0xC000021A)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\\\Windows\\\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000007b.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x0000007B)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "SSD 상태를 확인하는 무료 도구가 있나요?", "a": "CrystalDiskInfo 같은 무료 프로그램으로 SSD의 건강 상태와 온도를 확인할 수 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000001e.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000001E)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000001a.html", faq: [{"q": "게임할 때만 재부팅되면 그래픽카드 문제인가요?", "a": "이 문제(0x0000001A)는 그래픽 드라이버 문제일 가능성이 높지만 전원 공급이나 온도 문제와 겹치는 경우도 많아, 드라이버 재설치와 함께 온도·전력 상태도 함께 확인하는 것이 좋습니다."}, {"q": "전원 공급 장치(PSU) 용량이 부족한지 어떻게 확인하나요?", "a": "그래픽카드·CPU 권장 용량의 합을 계산해 PSU 정격 용량과 비교하면 부족 여부를 가늠할 수 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000050.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000050)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "최근에 설치한 프로그램이 원인일 수도 있나요?", "a": "네, 최근 설치한 드라이버나 소프트웨어가 원인인 경우가 많아 시스템 복원 지점으로 되돌리는 것도 방법입니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000004e.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000004E)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000c5.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000C5)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000008e.html", faq: [{"q": "0x8E은 왜 그렇게 많이 나타나나요?", "a": "이 오류는 매우 광범위한 원인을 나타내기 때문입니다. 드라이버 오류부터 메모리 문제, 심지어 하드웨어 불안정성까지 다양한 원인을 포괄하므로, 가장 먼저 확인할 항목을 체계적으로 정렬하는 것이 중요합니다."}, {"q": "이 오류가 자동 복구 루프를 만들 수도 있나요?", "a": "네, 부팅 중에 발생하면 자동 복구 루프에 빠질 수 있습니다. 이 경우 안전 모드나 복구 환경에서 진단해야 합니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070002.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x80070002)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "자동 복구가 계속 실패하면 윈도우를 재설치해야 하나요?", "a": "명령 프롬프트에서 부팅 복구 명령을 먼저 시도해보고, 그래도 안 되면 초기화나 재설치를 고려하는 것이 순서입니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0xc000000e.html", faq: [{"q": "BIOS에서 SSD가 보이면 디스크 고장은 아닌가요?", "a": "BIOS에서 장치가 보이는 것만으로 Windows Boot Manager나 BCD가 정상이라는 뜻은 아닙니다. 부팅 순서와 EFI 시스템 파티션, 운영체제 볼륨 접근을 별도로 확인해야 합니다."}, {"q": "복구 명령을 바로 실행해도 되나요?", "a": "중요한 파일이 있다면 먼저 백업 가능성을 확인하세요. 디스크가 BIOS에서도 사라지거나 읽기 오류가 반복되면 BCD 수정보다 저장장치 상태와 데이터 보존을 우선해야 합니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0xc004f050.html", faq: [{"q": "Home에 Pro 제품 키를 입력해도 되나요?", "a": "제품 키와 설치된 Windows 에디션이 맞아야 합니다. Home과 Pro가 다르면 키가 유효해도 0xC004F050이 발생할 수 있으므로 에디션을 먼저 확인하세요."}, {"q": "제품 키를 공개해도 되나요?", "a": "제품 키 전체는 공유하거나 게시하지 마세요. 구매 증빙과 키는 판매처 또는 Microsoft 공식 지원에만 제공하는 것이 안전합니다."}],
      relatedSymptom: "windows-activation-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070057.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x80070057)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "복구 화면에서 명령 프롬프트는 어떻게 여나요?", "a": "고급 옵션 → 문제 해결 → 고급 옵션 → 명령 프롬프트 순서로 진입할 수 있습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800f0922.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x800F0922)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "외장 하드를 연결한 상태에서도 복구를 시도해도 되나요?", "a": "외장 장치가 부팅 순서에 영향을 줄 수 있으므로, 복구 시도 전에는 분리하는 것이 좋습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070005.html", faq: [{"q": "프린터를 재설치하면 바로 해결되나요?", "a": "이 문제(0x80070005)는 드라이버보다 서비스나 권한 문제인 경우가 많아, 재설치 전에 스풀러 서비스 상태부터 확인하는 것이 순서상 더 빠릅니다."}, {"q": "프린터 스풀러 서비스를 재시작하면 도움이 되나요?", "a": "네, services.msc에서 Print Spooler 서비스를 재시작하면 멈춰있던 인쇄 대기열이 정리되며 문제가 해결되는 경우가 많습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x80004005.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x80004005)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "자동 복구가 계속 실패하면 윈도우를 재설치해야 하나요?", "a": "명령 프롬프트에서 부팅 복구 명령을 먼저 시도해보고, 그래도 안 되면 초기화나 재설치를 고려하는 것이 순서입니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0xc000000f.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0xC000000F)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "복구 화면에서 명령 프롬프트는 어떻게 여나요?", "a": "고급 옵션 → 문제 해결 → 고급 옵션 → 명령 프롬프트 순서로 진입할 수 있습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000ef.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000EF)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "블루스크린 이후 데이터가 손상되나요?", "a": "대부분은 강제 재시작만 발생할 뿐 저장된 파일이 곧바로 손상되지는 않지만, 저장하지 않은 작업 내용은 사라질 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000d1.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000D1)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\\\Windows\\\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000009f.html", faq: [{"q": "절전 모드를 아예 꺼야 하나요?", "a": "이 문제(0x0000009F)가 반복된다면 절전 기능 자체를 끄기보다 관련 드라이버와 전원 설정을 먼저 점검해, 절전 기능을 그대로 쓸 수 있는지 확인하는 것이 좋습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000116.html", faq: [{"q": "게임할 때만 재부팅되면 그래픽카드 문제인가요?", "a": "이 문제(0x00000116)는 그래픽 드라이버 문제일 가능성이 높지만 전원 공급이나 온도 문제와 겹치는 경우도 많아, 드라이버 재설치와 함께 온도·전력 상태도 함께 확인하는 것이 좋습니다."}, {"q": "쿨링 문제인지 전원 문제인지 구분하는 방법이 있나요?", "a": "재부팅 직전 온도를 모니터링 프로그램으로 확인해, 온도가 정상 범위인데도 재부팅된다면 전원 문제일 가능성이 높습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000133.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x00000133)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "오래된 SSD라서 그런 걸까요?", "a": "사용 기간보다는 남은 수명(TBW)과 펌웨어 버전이 더 중요한 지표이므로 진단 도구로 확인하는 것이 좋습니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000003b.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000003B)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "최근에 설치한 프로그램이 원인일 수도 있나요?", "a": "네, 최근 설치한 드라이버나 소프트웨어가 원인인 경우가 많아 시스템 복원 지점으로 되돌리는 것도 방법입니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000ea.html", faq: [{"q": "게임할 때만 재부팅되면 그래픽카드 문제인가요?", "a": "이 문제(0x000000EA)는 그래픽 드라이버 문제일 가능성이 높지만 전원 공급이나 온도 문제와 겹치는 경우도 많아, 드라이버 재설치와 함께 온도·전력 상태도 함께 확인하는 것이 좋습니다."}, {"q": "콘센트나 멀티탭도 원인이 될 수 있나요?", "a": "드물지만 불안정한 멀티탭이나 정전압 문제가 원인이 될 수 있어, 다른 콘센트로 테스트해보는 것도 방법입니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000007e.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000007E)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "블루스크린 이후 데이터가 손상되나요?", "a": "대부분은 강제 재시작만 발생할 뿐 저장된 파일이 곧바로 손상되지는 않지만, 저장하지 않은 작업 내용은 사라질 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000000a.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000000A)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\\\Windows\\\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000024.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x00000024)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "BIOS 설정도 영향을 주나요?", "a": "네, SATA 모드(AHCI/RAID)나 고속 부팅 설정이 인식 지연에 영향을 줄 수 있어 BIOS 설정을 함께 확인해야 합니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000f4.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x000000F4)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "외장 하드를 연결한 상태에서도 복구를 시도해도 되나요?", "a": "외장 장치가 부팅 순서에 영향을 줄 수 있으므로, 복구 시도 전에는 분리하는 것이 좋습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000019.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000019)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "최근에 설치한 프로그램이 원인일 수도 있나요?", "a": "네, 최근 설치한 드라이버나 소프트웨어가 원인인 경우가 많아 시스템 복원 지점으로 되돌리는 것도 방법입니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000a5.html", faq: [{"q": "화면이 안 나오면 모니터부터 의심해야 하나요?", "a": "이 문제(0x000000A5)가 표시된다면 모니터보다 메인보드·그래픽카드의 초기화 단계를 먼저 봐야 합니다. 다른 모니터나 케이블로 교차 확인하는 것도 원인을 좁히는 데 도움이 됩니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000074.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x00000074)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "자동 복구가 계속 실패하면 윈도우를 재설치해야 하나요?", "a": "명령 프롬프트에서 부팅 복구 명령을 먼저 시도해보고, 그래도 안 되면 초기화나 재설치를 고려하는 것이 순서입니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0xc0000225.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0xC0000225)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "복구 화면에서 명령 프롬프트는 어떻게 여나요?", "a": "고급 옵션 → 문제 해결 → 고급 옵션 → 명령 프롬프트 순서로 진입할 수 있습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070570.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x80070570)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "SSD 상태를 확인하는 무료 도구가 있나요?", "a": "CrystalDiskInfo 같은 무료 프로그램으로 SSD의 건강 상태와 온도를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000c2.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000C2)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "블루스크린 이후 데이터가 손상되나요?", "a": "대부분은 강제 재시작만 발생할 뿐 저장된 파일이 곧바로 손상되지는 않지만, 저장하지 않은 작업 내용은 사라질 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000ed.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(0x000000ED)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "외장 하드를 연결한 상태에서도 복구를 시도해도 되나요?", "a": "외장 장치가 부팅 순서에 영향을 줄 수 있으므로, 복구 시도 전에는 분리하는 것이 좋습니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000f7.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000F7)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\\\Windows\\\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000d8.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000D8)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "최근에 설치한 프로그램이 원인일 수도 있나요?", "a": "네, 최근 설치한 드라이버나 소프트웨어가 원인인 경우가 많아 시스템 복원 지점으로 되돌리는 것도 방법입니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000009c.html", faq: [{"q": "게임할 때만 재부팅되면 그래픽카드 문제인가요?", "a": "이 문제(0x0000009C)는 그래픽 드라이버 문제일 가능성이 높지만 전원 공급이나 온도 문제와 겹치는 경우도 많아, 드라이버 재설치와 함께 온도·전력 상태도 함께 확인하는 것이 좋습니다."}, {"q": "전원 공급 장치(PSU) 용량이 부족한지 어떻게 확인하나요?", "a": "그래픽카드·CPU 권장 용량의 합을 계산해 PSU 정격 용량과 비교하면 부족 여부를 가늠할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000077.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x00000077)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "오래된 SSD라서 그런 걸까요?", "a": "사용 기간보다는 남은 수명(TBW)과 펌웨어 버전이 더 중요한 지표이므로 진단 도구로 확인하는 것이 좋습니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000be.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000BE)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "블루스크린 이후 데이터가 손상되나요?", "a": "대부분은 강제 재시작만 발생할 뿐 저장된 파일이 곧바로 손상되지는 않지만, 저장하지 않은 작업 내용은 사라질 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000007a.html", faq: [{"q": "SSD·NVMe를 바로 교체해야 하나요?", "a": "이 문제(0x0000007A)만으로 저장장치 고장을 단정하기는 어렵습니다. 슬롯 재장착과 펌웨어 업데이트를 먼저 확인한 뒤에도 반복되면 다른 슬롯이나 드라이브로 교차 테스트해보는 것이 안전합니다."}, {"q": "BIOS 설정도 영향을 주나요?", "a": "네, SATA 모드(AHCI/RAID)나 고속 부팅 설정이 인식 지연에 영향을 줄 수 있어 BIOS 설정을 함께 확인해야 합니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
      ...
      code: "0x800F081F", title: "원본 파일을 찾을 수 없음", overview: "Windows 선택적 기능을 추가하거나 DISM으로 시스템 이미지를 복구할 때, 필요한 구성 요소의 원본 파일을 로컬 저장소나 Windows Update 서버에서 찾지 못해 실패하는 코드입니다. 구성 요소 저장소 손상이나 잘못된 설치 미디어 경로 지정이 대표적인 원인입니다.", summary: "Windows 기능 추가나 복구 과정에서 필요한 구성 요소 원본을 찾지 못할 때 보이는 코드입니다.", causes: ["Windows 구성 요소 저장소(WinSxS)의 해당 항목이 손상되었거나 누락된 경우", "DISM 명령에 지정한 설치 미디어(install.wim/install.esd) 경로나 인덱스 번호가 잘못된 경우", "Windows Update를 통한 원본 파일 다운로드가 정책이나 네트워크 문제로 차단된 경우", "그룹 정책에서 Windows Update를 통한 복구가 금지되도록 설정된 경우", "설치 미디어의 Windows 버전이나 빌드가 현재 시스템과 일치하지 않는 경우"], checks: ["DISM /Online /Cleanup-Image /ScanHealth로 손상 여부를 먼저 확인하세요.", "인터넷에 연결된 상태에서 DISM /Online /Cleanup-Image /RestoreHealth를 실행해 Windows Update에서 원본 파일을 받도록 하세요.", "그룹 정책(gpedit.msc)에서 구성 요소 복구 관련 정책이 차단되어 있는지 확인하세요.", "설치 미디어를 사용한다면 /Source 옵션에 install.wim이나 install.esd의 정확한 경로와 인덱스를 지정하세요.", "현재 Windows 버전과 빌드가 일치하는 설치 미디어를 새로 받아 다시 시도하세요."], link: "error-code-0x800f081f.html", detailPage: "error-code-0x800f081f.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x800F081F)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}], relatedSymptom: "windows-update-fail-loop.html", aliases: ["800f081f", "0x800f081f"], communityCases: [{"title":".NET Framework 오프라인 설치로 해결","summary":"특정 프로그램 설치 중 소스 파일을 찾을 수 없다는 오류와 함께 .NET Framework 3.5 활성화에 실패했던 사례가 있습니다. 인터넷 연결 없이 윈도우 설치 미디어를 소스로 지정해 DISM 명령을 실행하자 정상적으로 활성화됐습니다.","insight":"이 오류로 .NET Framework 활성화가 안 된다면 온라인 대신 설치 미디어(USB나 ISO)의 install.wim을 소스로 지정하는 오프라인 방식이 효과적입니다."}], officialSource: {"title":"Microsoft Learn: Fix Windows Update errors (DISM source files)","url":"https://learn.microsoft.com/en-us/troubleshoot/windows-server/installing-updates-features-roles/fix-windows-update-errors"} },
    {
      ...
      detailPage: "error-code-0x800f0831.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x800F0831)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800b0101.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x800B0101)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
      ...
      code: "0xC1900101", title: "업데이트 드라이버 호환성 실패", overview: "Windows 기능 업데이트(대규모 버전 업그레이드) 도중 특정 드라이버가 새 환경으로 전환하거나 이전 버전으로 롤백하는 단계에서 응답하지 않거나 충돌할 때 나타나는 코드입니다. 저장장치·그래픽 드라이버와 외장 장치 드라이버가 가장 흔한 원인으로 지목됩니다.", summary: "Windows 기능 업데이트 중 드라이버가 설치 또는 롤백 단계에서 충돌할 때 자주 보이는 코드입니다.", causes: ["저장장치(SSD/NVMe) 컨트롤러 드라이버가 새 Windows 빌드와 호환되지 않는 경우", "그래픽 드라이버가 업그레이드 과정에서 초기화에 실패하는 경우", "USB로 연결된 외장 장치(프린터, 외장하드, 카드리더 등)의 드라이버가 충돌하는 경우", "메인보드 BIOS나 제조사 전용 유틸리티가 오래되어 업그레이드 절차와 맞지 않는 경우", "이전 업그레이드 시도의 잔여 파일이 새 시도와 충돌하는 경우"], checks: ["업그레이드 전 불필요한 외장 장치를 모두 분리하세요.", "저장장치·그래픽 드라이버를 최신 버전으로 업데이트하세요.", "메인보드 제조사 홈페이지에서 BIOS와 칩션 드라이버가 최신인지 확인하세요.", "setupact.log에서 실패를 유발한 드라이버를 확인하세요.", "설치 미디어를 새로 만들어 클린 업그레이드를 시도해 보세요."], link: "error-code-0xc1900101.html", detailPage: "error-code-0xc1900101.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0xC1900101)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}], relatedSymptom: "windows-update-fail-loop.html", aliases: ["c1900101", "0xc1900101"], communityCases: [{"title":"구형 드라이버 수동 제거 후 업그레이드 성공","summary":"윈도우 10에서 11로 업그레이드 시도 시 이 오류가 반복됐던 사례가 있습니다. SetupDiag 도구로 분석하니 구형 네트워크 카드 드라이버가 원인으로 지목됐고, 해당 드라이버를 제거한 뒤 업그레이드를 다시 시도하자 성공했습니다.","insight":"업그레이드 중 이 오류가 발생하면 SetupDiag 도구를 먼저 실행해 정확한 원인 드라이버를 찾는 것이 효율적입니다. 원인 드라이버를 제거하고 업그레이드 후 다시 설치하면 됩니다."}], officialSource: {"title":"Microsoft Learn: Windows 10 upgrade resolution procedures","url":"https://learn.microsoft.com/en-us/troubleshoot/windows-client/setup-upgrade-and-drivers/windows-10-upgrade-resolution-procedures"} },
    {
      ...
      detailPage: "error-code-0x80240034.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x80240034)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "수동으로 업데이트를 받아 설치해도 되나요?", "a": "Microsoft Update 카탈로그에서 해당 KB 번호를 직접 받아 설치하면 자동 업데이트 오류를 우회할 수 있는 경우가 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8024402c.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8024402C)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트를 미루면 보안에 문제가 되나요?", "a": "보안 업데이트가 누락되면 취약점 노출 위험이 커지므로, 오류를 바로 해결하지 못했다면 최소한 원인 진단이라도 진행하는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80073712.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x80073712)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8007232b.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8007232B)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "수동으로 업데이트를 받아 설치해도 되나요?", "a": "Microsoft Update 카탈로그에서 해당 KB 번호를 직접 받아 설치하면 자동 업데이트 오류를 우회할 수 있는 경우가 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800f0821.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x800f0821)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트를 미루면 보안에 문제가 되나요?", "a": "보안 업데이트가 누락되면 취약점 노출 위험이 커지므로, 오류를 바로 해결하지 못했다면 최소한 원인 진단이라도 진행하는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8024a105.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8024a105)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070020.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x80070020)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "수동으로 업데이트를 받아 설치해도 되나요?", "a": "Microsoft Update 카탈로그에서 해당 KB 번호를 직접 받아 설치하면 자동 업데이트 오류를 우회할 수 있는 경우가 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8007000e.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8007000e)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트를 미루면 보안에 문제가 되나요?", "a": "보안 업데이트가 누락되면 취약점 노출 위험이 커지므로, 오류를 바로 해결하지 못했다면 최소한 원인 진단이라도 진행하는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800705b4.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x800705b4)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070003.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x80070003)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "수동으로 업데이트를 받아 설치해도 되나요?", "a": "Microsoft Update 카탈로그에서 해당 KB 번호를 직접 받아 설치하면 자동 업데이트 오류를 우회할 수 있는 경우가 있습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800704cf.html", faq: [{"q": "공유기를 바꾸면 해결되나요?", "a": "이 문제(0x800704CF)는 공유기 자체 문제보다 어댑터 드라이버나 전원 관리 설정이 원인인 경우가 많아, 장비 교체 전에 드라이버 업데이트와 절전 설정부터 확인해보세요."}, {"q": "공유기를 바꾸면 확실히 해결되나요?", "a": "공유기 노후화가 원인이라면 도움이 되지만, PC의 무선랜 드라이버나 절전 설정이 원인이라면 공유기를 바꿔도 재발할 수 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070035.html", faq: [{"q": "탐색기가 멈추면 바로 재설치해야 하나요?", "a": "이 문제(0x80070035)는 재설치보다 셸 재시작과 원인이 되는 폴더·드라이브 분리로 대부분 해결됩니다. 재설치는 이 단계 이후에도 반복될 때 고려하세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070718.html", faq: [{"q": "공유기를 바꾸면 해결되나요?", "a": "이 문제(0x80070718)는 공유기 자체 문제보다 어댑터 드라이버나 전원 관리 설정이 원인인 경우가 많아, 장비 교체 전에 드라이버 업데이트와 절전 설정부터 확인해보세요."}, {"q": "5GHz와 2.4GHz 중 뭐가 더 안정적인가요?", "a": "5GHz는 속도가 빠르지만 벽 등 장애물에 약해 거리가 멀면 오히려 끊김이 잦을 수 있어, 상황에 따라 2.4GHz가 더 안정적일 수 있습니다."}],
      relatedSymptom: "hardware-wifi-disconnect.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80072efd.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x80072EFD)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트를 미루면 보안에 문제가 되나요?", "a": "보안 업데이트가 누락되면 취약점 노출 위험이 커지므로, 오류를 바로 해결하지 못했다면 최소한 원인 진단이라도 진행하는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070490.html", faq: [{"q": "공유기를 바꾸면 해결되나요?", "a": "이 문제(0x80070490)는 공유기 자체 문제보다 어댑터 드라이버나 전원 관리 설정이 원인인 경우가 많아, 장비 교체 전에 드라이버 업데이트와 절전 설정부터 확인해보세요."}, {"q": "무선랜 어댑터의 절전 설정을 꺼야 하나요?", "a": "네, 전원 관리에서 무선랜 어댑터의 절전 기능을 꺼두면 백그라운드에서 연결이 끊기는 현상을 줄일 수 있습니다."}],
      relatedSymptom: "hardware-wifi-disconnect.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8007274c.html", faq: [{"q": "업데이트를 계속 재시도해도 괜찮은가요?", "a": "이 문제(0x8007274C)로 반복 실패한다면 무한정 재시도하기보다 업데이트 구성 요소 정리와 디스크 공간 확인을 먼저 하는 것이 시간을 아낄 수 있습니다."}, {"q": "업데이트 오류 코드마다 해결법이 다른가요?", "a": "공통 원인(구성 요소 정리, 디스크 공간)이 많지만 코드별로 원인이 갈리는 경우도 있어, 코드 자체를 함께 검색해보는 것이 좋습니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x800704b3.html", faq: [{"q": "프린터를 재설치하면 바로 해결되나요?", "a": "이 문제(0x800704B3)는 드라이버보다 서비스나 권한 문제인 경우가 많아, 재설치 전에 스풀러 서비스 상태부터 확인하는 것이 순서상 더 빠릅니다."}, {"q": "네트워크 프린터와 USB 프린터 중 어느 쪽이 더 자주 멈추나요?", "a": "네트워크 프린터가 네트워크 상태에 따라 추가 단계에서 더 자주 멈추는 경향이 있어, 유선 연결 상태를 먼저 확인하는 것이 좋습니다."}],
      relatedSymptom: "windows-printer-add-freeze.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070102.html", faq: [{"q": "공유기를 바꾸면 해결되나요?", "a": "이 문제(0x80070102)는 공유기 자체 문제보다 어댑터 드라이버나 전원 관리 설정이 원인인 경우가 많아, 장비 교체 전에 드라이버 업데이트와 절전 설정부터 확인해보세요."}, {"q": "공유기를 바꾸면 확실히 해결되나요?", "a": "공유기 노후화가 원인이라면 도움이 되지만, PC의 무선랜 드라이버나 절전 설정이 원인이라면 공유기를 바꿔도 재발할 수 있습니다."}],
      relatedSymptom: "hardware-wifi-disconnect.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-10.html", faq: [{"q": "장치가 인식이 안 되면 바로 새 제품을 사야 하나요?", "a": "이 문제(코드 10)는 장치 고장보다 드라이버나 포트 설정 문제인 경우가 흔합니다. 다른 포트나 다른 PC에서 인식되는지 먼저 확인해보세요."}, {"q": "USB 드라이버를 삭제하면 어떻게 되나요?", "a": "장치 관리자에서 드라이버를 제거한 뒤 재부팅하면 Windows가 드라이버를 자동으로 다시 설치하며, 이 과정에서 인식 문제가 해결되는 경우가 있습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-43.html", faq: [{"q": "게임할 때만 재부팅되면 그래픽카드 문제인가요?", "a": "이 문제(코드 43)는 그래픽 드라이버 문제일 가능성이 높지만 전원 공급이나 온도 문제와 겹치는 경우도 많아, 드라이버 재설치와 함께 온도·전력 상태도 함께 확인하는 것이 좋습니다."}, {"q": "콘센트나 멀티탭도 원인이 될 수 있나요?", "a": "드물지만 불안정한 멀티탭이나 정전압 문제가 원인이 될 수 있어, 다른 콘센트로 테스트해보는 것도 방법입니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-28.html", faq: [{"q": "장치가 인식이 안 되면 바로 새 제품을 사야 하나요?", "a": "이 문제(코드 28)는 장치 고장보다 드라이버나 포트 설정 문제인 경우가 흔합니다. 다른 포트나 다른 PC에서 인식되는지 먼저 확인해보세요."}, {"q": "다른 PC에서는 잘 되는 장치인데 인식이 안 되면 뭐가 문제인가요?", "a": "장치 자체보다는 현재 PC의 USB 컨트롤러 드라이버나 전원 관리 설정 문제일 가능성이 높습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-39.html", faq: [{"q": "소리가 안 나면 스피커나 이어폰부터 바꿔야 하나요?", "a": "이 문제(코드 39)는 장치 자체보다 드라이버나 서비스 문제인 경우가 많으니, 다른 장치로 교차 확인한 뒤에 장치 교체를 고려해도 늦지 않습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-31.html", faq: [{"q": "장치가 인식이 안 되면 바로 새 제품을 사야 하나요?", "a": "이 문제(코드 31)는 장치 고장보다 드라이버나 포트 설정 문제인 경우가 흔합니다. 다른 포트나 다른 PC에서 인식되는지 먼저 확인해보세요."}, {"q": "USB 포트 전원 관리 설정이 영향을 주나요?", "a": "네, Windows의 USB 선택적 절전 설정이 활성화되어 있으면 일부 장치의 연결이 끊기거나 인식이 지연될 수 있습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-34.html", faq: [{"q": "장치가 인식이 안 되면 바로 새 제품을 사야 하나요?", "a": "이 문제(코드 34)는 장치 고장보다 드라이버나 포트 설정 문제인 경우가 흔합니다. 다른 포트나 다른 PC에서 인식되는지 먼저 확인해보세요."}, {"q": "USB 드라이버를 삭제하면 어떻게 되나요?", "a": "장치 관리자에서 드라이버를 제거한 뒤 재부팅하면 Windows가 드라이버를 자동으로 다시 설치하며, 이 과정에서 인식 문제가 해결되는 경우가 있습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-19.html", faq: [{"q": "복구 화면에서 초기화를 바로 눌러도 되나요?", "a": "이 문제(코드 19)가 반복된다면 초기화 전에 먼저 안전 모드 진입과 최근 변경 사항 확인을 시도해보세요. 초기화는 되돌리기 어려우니 마지막 단계로 남겨두는 것이 좋습니다."}, {"q": "자동 복구가 계속 실패하면 윈도우를 재설치해야 하나요?", "a": "명령 프롬프트에서 부팅 복구 명령을 먼저 시도해보고, 그래도 안 되면 초기화나 재설치를 고려하는 것이 순서입니다."}],
      relatedSymptom: "windows-auto-repair-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-41.html", faq: [{"q": "장치가 인식이 안 되면 바로 새 제품을 사야 하나요?", "a": "이 문제(코드 41)는 장치 고장보다 드라이버나 포트 설정 문제인 경우가 흔합니다. 다른 포트나 다른 PC에서 인식되는지 먼저 확인해보세요."}, {"q": "다른 PC에서는 잘 되는 장치인데 인식이 안 되면 뭐가 문제인가요?", "a": "장치 자체보다는 현재 PC의 USB 컨트롤러 드라이버나 전원 관리 설정 문제일 가능성이 높습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-1603.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 1603)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "설치 로그는 어디서 확인하나요?", "a": "%temp% 폴더의 MSI 로그 파일에서 실패 지점을 확인하면 원인을 더 정확히 좁힐 수 있습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-1618.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 1618)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "이전 버전을 지우지 않고 업데이트 설치하면 안 되나요?", "a": "일부 프로그램은 가능하지만, 오류가 반복된다면 이전 버전을 완전히 제거한 뒤 재설치하는 것이 안전합니다."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-2503.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 2503)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "설치 오류가 백신 때문인지 어떻게 확인하나요?", "a": "백신을 끄기 전에 차단·격리 기록과 설치 파일의 공식 출처를 확인하세요. 꼭 필요한 경우에만 짧게 보호 기능을 중지해 비교하고 설치가 끝나면 즉시 다시 켜세요."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-2502.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 2502)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "설치 로그는 어디서 확인하나요?", "a": "%temp% 폴더의 MSI 로그 파일에서 실패 지점을 확인하면 원인을 더 정확히 좁힐 수 있습니다."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-80070643.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 0x80070643)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "이전 버전을 지우지 않고 업데이트 설치하면 안 되나요?", "a": "일부 프로그램은 가능하지만, 오류가 반복된다면 이전 버전을 완전히 제거한 뒤 재설치하는 것이 안전합니다."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-1935.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 1935)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "설치 오류가 백신 때문인지 어떻게 확인하나요?", "a": "백신을 끄기 전에 차단·격리 기록과 설치 파일의 공식 출처를 확인하세요. 꼭 필요한 경우에만 짧게 보호 기능을 중지해 비교하고 설치가 끝나면 즉시 다시 켜세요."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-install-access-denied.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 0x80070005 (설치))는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "설치 로그는 어디서 확인하나요?", "a": "%temp% 폴더의 MSI 로그 파일에서 실패 지점을 확인하면 원인을 더 정확히 좁힐 수 있습니다."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-1719.html", faq: [{"q": "설치 오류가 나면 프로그램을 다시 받으면 되나요?", "a": "이 문제(오류 1719)는 설치 파일보다 Windows Installer 서비스나 잔여 파일이 원인인 경우가 많아, 재다운로드 전에 서비스 상태와 이전 설치 흔적부터 정리해보세요."}, {"q": "이전 버전을 지우지 않고 업데이트 설치하면 안 되나요?", "a": "일부 프로그램은 가능하지만, 오류가 반복된다면 이전 버전을 완전히 제거한 뒤 재설치하는 것이 안전합니다."}],
      relatedSymptom: "windows-install-failure.html",
    ...
    },
    {
      ...
      detailPage: "error-code-c0000142.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(0xc0000142)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "필수 구성 요소(Visual C++ 등)를 어떻게 확인하나요?", "a": "제어판의 프로그램 목록에서 Visual C++ Redistributable이 설치되어 있는지 확인하고, 없다면 Microsoft 공식 사이트에서 받아 설치해야 합니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-c000007b.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(0xc000007b)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "호환성 모드로 실행하면 도움이 되나요?", "a": "오래된 프로그램이라면 호환성 모드가 도움이 될 수 있지만, 최신 프로그램의 오류라면 다른 원인을 먼저 점검해야 합니다."}],
      relatedSymptom: "windows-app-not-launching.html",
    ...
    },
    {
      ...
      detailPage: "error-code-c0000005.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(0xc0000005)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "바이러스 때문에 실행이 차단된 걸 수도 있나요?", "a": "백신이 오탐으로 실행 파일을 격리했을 수 있으므로, 백신의 격리소·검역소 목록을 확인하는 것도 방법입니다."}],
      relatedSymptom: "windows-app-not-launching.html",
    ...
    },
    {
      ...
      detailPage: "error-code-msvcp140.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(MSVCP140.dll 오류)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "필수 구성 요소(Visual C++ 등)를 어떻게 확인하나요?", "a": "제어판의 프로그램 목록에서 Visual C++ Redistributable이 설치되어 있는지 확인하고, 없다면 Microsoft 공식 사이트에서 받아 설치해야 합니다."}],
      relatedSymptom: "windows-app-not-launching.html",
    ...
    },
    {
      ...
      detailPage: "error-code-app-cant-run-on-pc.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(이 앱이 PC에서 실행되지 않습니다)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "호환성 모드로 실행하면 도움이 되나요?", "a": "오래된 프로그램이라면 호환성 모드가 도움이 될 수 있지만, 최신 프로그램의 오류라면 다른 원인을 먼저 점검해야 합니다."}],
      relatedSymptom: "windows-app-not-launching.html",
    ...
    },
    {
      ...
      detailPage: "error-code-browser-not-responding.html", faq: [{"q": "브라우저가 자주 멈추면 다른 브라우저로 바꿔야 하나요?", "a": "이 문제(브라우저 응답 없음)는 브라우저 자체보다 확장 프로그램이나 캐시 문제인 경우가 많아, 브라우저를 바꾸기 전에 확장 프로그램 정리부터 시도해보세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-aw-snap.html", faq: [{"q": "브라우저가 자주 멈추면 다른 브라우저로 바꿔야 하나요?", "a": "이 문제(Aw Snap 오류)는 브라우저 자체보다 확장 프로그램이나 캐시 문제인 경우가 많아, 브라우저를 바꾸기 전에 확장 프로그램 정리부터 시도해보세요."}],
      relatedSymptom: "windows-browser-not-responding.html",
    ...
    },
    {
      ...
      detailPage: "error-code-c0000022.html", faq: [{"q": "앱이 실행되지 않으면 무조건 재설치해야 하나요?", "a": "이 문제(0xc0000022)는 재설치보다 런타임 구성 요소(비주얼 C++ 등) 문제인 경우가 많아, 재설치 전에 필수 구성 요소부터 점검하는 것이 좋습니다."}, {"q": "바이러스 때문에 실행이 차단된 걸 수도 있나요?", "a": "백신이 오탐으로 실행 파일을 격리했을 수 있으므로, 백신의 격리소·검역소 목록을 확인하는 것도 방법입니다."}],
      relatedSymptom: "windows-app-not-launching.html",
    ...
    },
    {
      ...
      detailPage: "error-code-vanguard-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(뱅가드 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "안티치트 오류는 항상 게임사 문제인가요?", "a": "게임사 서버 문제일 수도 있지만, 상당수는 로컬 PC의 드라이버·백신 충돌이 원인이므로 먼저 자가 점검을 해보는 것이 좋습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-easyanticheat-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(이지 안티치트 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "게임을 재설치하면 확실히 해결되나요?", "a": "파일 손상이 원인이라면 해결되지만, 드라이버나 안티치트 자체 문제라면 재설치만으로는 해결되지 않을 수 있습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-battlenet-error.html", faq: [{"q": "연결 오류가 나면 인터넷 회선부터 의심해야 하나요?", "a": "이 문제(배틀넷 연결 오류)는 회선 자체보다 런처 캐시나 서버 상태 문제인 경우가 많아, 회선 점검 전에 공식 서버 상태부터 확인해보세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-lostark-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(로스트아크 실행 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "같은 오류가 다른 게임에서도 나면 원인이 같은가요?", "a": "네, 여러 게임에서 동일한 안티치트나 런처를 공유하는 경우 원인이 같을 가능성이 높습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-maplestory-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(메이플스토리 실행 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "안티치트 오류는 항상 게임사 문제인가요?", "a": "게임사 서버 문제일 수도 있지만, 상당수는 로컬 PC의 드라이버·백신 충돌이 원인이므로 먼저 자가 점검을 해보는 것이 좋습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-lol-patch-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(리그오브레전드 패치 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "게임을 재설치하면 확실히 해결되나요?", "a": "파일 손상이 원인이라면 해결되지만, 드라이버나 안티치트 자체 문제라면 재설치만으로는 해결되지 않을 수 있습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-suddenattack-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(서든어택 넷프로텍트 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "같은 오류가 다른 게임에서도 나면 원인이 같은가요?", "a": "네, 여러 게임에서 동일한 안티치트나 런처를 공유하는 경우 원인이 같을 가능성이 높습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-fconline-error.html", faq: [{"q": "게임이 실행되지 않으면 게임을 삭제하고 다시 깔아야 하나요?", "a": "이 문제(FC 온라인 실행 오류)는 게임 파일보다 안티치트 드라이버 문제인 경우가 많아, 전체 재설치 전에 안티치트 재설치 도구부터 사용해보세요."}, {"q": "안티치트 오류는 항상 게임사 문제인가요?", "a": "게임사 서버 문제일 수도 있지만, 상당수는 로컬 PC의 드라이버·백신 충돌이 원인이므로 먼저 자가 점검을 해보는 것이 좋습니다."}],
      relatedSymptom: "windows-game-launch-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-24.html", faq: [{"q": "블루투스 장치가 안 잡히면 장치를 바꿔야 하나요?", "a": "이 문제(코드 24)는 장치보다 어댑터 드라이버나 페어링 기록 문제인 경우가 많아, 장치 교체 전에 드라이버 재설치와 페어링 재등록을 먼저 시도해보세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-device-manager-code-45.html", faq: [{"q": "블루투스 장치가 안 잡히면 장치를 바꿔야 하나요?", "a": "이 문제(코드 45)는 장치보다 어댑터 드라이버나 페어링 기록 문제인 경우가 많아, 장치 교체 전에 드라이버 재설치와 페어링 재등록을 먼저 시도해보세요."}],
      relatedSymptom: "hardware-bluetooth-not-found.html",
    ...
    },
    {
      ...
      detailPage: "error-code-explorer-black-screen.html", faq: [{"q": "검은 화면이 뜨면 바로 초기화해야 하나요?", "a": "이 문제(탐색기 시작 실패 (검은 화면))는 초기화 전에 explorer.exe 수동 실행과 안전 모드 확인만으로 해결되는 경우가 많으니, 초기화는 이 단계 이후로 미뤄도 됩니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-shell-extension-conflict.html", faq: [{"q": "작업표시줄이 멈추면 매번 재부팅해야 하나요?", "a": "이 문제(셸 확장 충돌 (작업표시줄 멈춤))는 재부팅보다 탐색기(Explorer) 재시작만으로도 대부분 풀리며, 반복된다면 최근 설치한 셸 확장 프로그램을 먼저 의심해보세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-tiworker-disk-100.html", faq: [{"q": "디스크 사용률이 100%면 디스크를 교체해야 하나요?", "a": "이 문제(TiWorker.exe 디스크 100%)는 디스크 고장보다 백그라운드 서비스가 원인인 경우가 많아, 교체 전에 해당 프로세스가 자연히 끝나는지 먼저 지켜보는 것이 좋습니다."}],
    ...
    },
    {
      ...
      detailPage: "error-code-sysmain-disk-100.html", faq: [{"q": "디스크 사용률이 100%면 디스크를 교체해야 하나요?", "a": "이 문제(SysMain 디스크 100%)는 디스크 고장보다 백그라운드 서비스가 원인인 경우가 많아, 교체 전에 해당 프로세스가 자연히 끝나는지 먼저 지켜보는 것이 좋습니다."}],
      relatedSymptom: "windows-disk-usage-100.html",
    ...
    },
    {
      ...
      detailPage: "error-code-explorer-network-drive-freeze.html", faq: [{"q": "탐색기가 멈추면 바로 재설치해야 하나요?", "a": "이 문제(네트워크 드라이브 탐색기 멈춤)는 재설치보다 셸 재시작과 원인이 되는 폴더·드라이브 분리로 대부분 해결됩니다. 재설치는 이 단계 이후에도 반복될 때 고려하세요."}],
      relatedSymptom: "windows-explorer-freeze.html",
    ...
    },
    {
      ...
      detailPage: "error-code-windows-audio-service-stopped.html", faq: [{"q": "소리가 안 나면 스피커나 이어폰부터 바꿔야 하나요?", "a": "이 문제(Windows Audio 서비스 응답 없음)는 장치 자체보다 드라이버나 서비스 문제인 경우가 많으니, 다른 장치로 교차 확인한 뒤에 장치 교체를 고려해도 늦지 않습니다."}],
      relatedSymptom: "hardware-sound-not-working.html",
    ...
    },
    {
      ...
      detailPage: "error-code-modern-standby-resume-fail.html", faq: [{"q": "절전 모드를 아예 꺼야 하나요?", "a": "이 문제(최신 대기 모드 절전 복귀 실패)가 반복된다면 절전 기능 자체를 끄기보다 관련 드라이버와 전원 설정을 먼저 점검해, 절전 기능을 그대로 쓸 수 있는지 확인하는 것이 좋습니다."}],
      relatedSymptom: "windows-sleep-resume-fail.html",
    ...
    },
    {
      ...
      detailPage: "error-code-print-spooler-not-responding.html", faq: [{"q": "프린터를 재설치하면 바로 해결되나요?", "a": "이 문제(인쇄 스풀러 서비스 응답 없음)는 드라이버보다 서비스나 권한 문제인 경우가 많아, 재설치 전에 스풀러 서비스 상태부터 확인하는 것이 순서상 더 빠릅니다."}, {"q": "제조사 전용 프로그램을 꼭 설치해야 하나요?", "a": "Windows 기본 드라이버로도 인쇄는 가능하지만, 제조사 프로그램을 설치하면 고급 기능과 상태 모니터링을 이용할 수 있습니다."}],
      relatedSymptom: "windows-printer-add-freeze.html",
    ...
    },
    {
      ...
      detailPage: "error-code-steam-connection-fail.html", faq: [{"q": "연결 오류가 나면 인터넷 회선부터 의심해야 하나요?", "a": "이 문제(스팀 서버 연결 실패)는 회선 자체보다 런처 캐시나 서버 상태 문제인 경우가 많아, 회선 점검 전에 공식 서버 상태부터 확인해보세요."}],
      relatedSymptom: "windows-game-connection-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000002e.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000002E)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000080.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000080)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000007f.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000007F)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000101.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000101)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000012b.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000012B)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000f2.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000F2)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000117.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000117)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000079.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000079)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-no-display.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x000000fe.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x000000FE)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000005c.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000005C)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-no-display.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000154.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000154)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-nvme-delay.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000109.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000109)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000009e.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000009E)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000119.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000119)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-gaming-reboot.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x0000013a.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x0000013A)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-bsod-critical-process.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000144.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000144)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "hardware-usb-not-detected.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000164.html", faq: [{"q": "블루스크린 코드가 한 번 떴는데 계속 지켜봐야 하나요?", "a": "이 문제(0x00000164)가 한 번만 발생했다면 즉시 부품을 교체하기보다 재현 여부와 최근 변경 사항을 먼저 기록해두는 것으로 충분합니다. 반복된다면 그때 하드웨어 점검 범위를 넓히세요."}, {"q": "덤프 파일은 어디서 확인하나요?", "a": "C:\\Windows\\Minidump 폴더에 저장되며, BlueScreenView 같은 도구로 열어 정지 코드와 관련 드라이버를 확인할 수 있습니다."}],
      relatedSymptom: "windows-black-screen-after-login.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80070079.html", faq: [{"q": "세마포 오류가 뜨면 저장장치가 고장난 건가요?", "a": "항상 그렇지는 않습니다. 무선 네트워크 불안정이나 케이블 접촉 불량처럼 연결 경로의 문제로도 자주 발생합니다. 유선 연결·케이블 교체부터 확인한 뒤에도 반복되면 저장장치 자체를 의심하세요."}, {"q": "외장 하드에서만 이 오류가 나는데 원인이 뭘까요?", "a": "USB-SATA 브리지 칩이나 케이블이 노후화되어 대용량 전송 중 응답이 늦어지는 경우가 흔합니다. 다른 케이블·포트로 바꿔 재현되는지 먼저 확인하세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0x00000709.html", faq: [{"q": "프린터를 삭제하고 다시 추가하면 설정이 다 사라지나요?", "a": "기본 인쇄 설정(용지 크기, 품질 등)은 초기화될 수 있지만, 문서나 인쇄 기록이 사라지지는 않습니다. 다시 추가한 뒤 필요한 설정만 다시 지정하면 됩니다."}, {"q": "다른 PC에서는 같은 프린터가 잘 되는데 제 PC에서만 안 돼요.", "a": "내 PC의 프린터 드라이버가 오래됐거나 손상됐을 가능성이 큽니다. 제조사 홈페이지에서 최신 드라이버를 받아 다시 설치해보세요."}],
    ...
    },
    {
      ...
      detailPage: "error-code-0xc004c003.html", faq: [{"q": "메인보드를 바꾸면 무조건 재인증해야 하나요?", "a": "디지털 라이선스가 Microsoft 계정에 연결되어 있었다면 계정 로그인만으로 자동 복구되는 경우가 많습니다. 연결되어 있지 않았다면 문제 해결사를 실행하거나 지원팀에 문의해야 합니다."}, {"q": "정품이 아닌데 이 오류가 뜨는 건가요?", "a": "아닙니다. 정품이라도 하드웨어 구성이 크게 바뀌면 일시적으로 이 오류가 나타날 수 있습니다. 문제 해결사와 계정 연결부터 먼저 시도하세요."}],
      relatedSymptom: "windows-activation-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x8007007b.html", faq: [{"q": "제품 키를 정확히 입력했는데도 이 오류가 뜨는 이유는?", "a": "키 자체보다 인증 서버와의 통신 문제인 경우가 흔합니다. 네트워크 연결부터 점검하고, 방화벽·백신이 차단하고 있지 않은지 확인하세요."}, {"q": "다른 PC에서 쓰던 키를 입력해도 되나요?", "a": "소매용(Retail) 키가 아니라면 한 번에 한 대의 PC에서만 활성화됩니다. 이미 다른 PC에서 사용 중이라면 이 오류가 발생할 수 있습니다."}],
      relatedSymptom: "windows-activation-error.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80240fff.html", faq: [{"q": "SoftwareDistribution 폴더를 지우면 업데이트 기록이 사라지나요?", "a": "이미 설치된 업데이트는 그대로 남고, 다운로드 캐시만 다시 받게 됩니다. 설치 기록이나 시스템 자체에는 영향이 없습니다."}, {"q": "매번 다른 코드가 뜨는데도 이 방법이 통하나요?", "a": "네, Windows Update 구성 요소 초기화는 원인이 명확하지 않은 대부분의 업데이트 오류에 공통으로 시도해볼 수 있는 기본 조치입니다."}],
      relatedSymptom: "windows-update-fail-loop.html",
    ...
    },
    {
      ...
      detailPage: "error-code-0x80073cf9.html", faq: [{"q": "Xbox 앱에서도 같은 코드가 뜨는데 원인이 같은가요?", "a": "네, Xbox 앱도 Microsoft Store와 같은 라이선스·캐시 구성 요소를 공유하기 때문에 같은 코드가 나타날 수 있고, 같은 방법(wsreset)으로 해결되는 경우가 많습니다."}, {"q": "스토어를 재설치하면 해결되나요?", "a": "재설치보다 재설정(초기화)이나 wsreset.exe로 캐시를 지우는 방법이 먼저 시도해볼 조치입니다. 대부분 재설치 없이 해결됩니다."}],
