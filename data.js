    ...
    "amd-cpu-cooler-pressure-no-post": {
      ...
      checks: [
        ...
        },
        {
          ...
          why: "손의 감각보다 반복 가능하게 조일 수 있지만, 잘못된 토크값은 오히려 과도한 압력을 만들 수 있습니다.",
          how: "쿨러 설명서가 최대 토크를 명시한 경우에만 해당 값 이하로 설정한 저토크 드라이버와 맞는 비트를 사용하세요. 수치가 없으면 임의의 범용값을 적용하지 마세요."
        },
        {
      ...
      deeper: [
        ...
        },
        {
          ...
          text: "Noctua는 자사 NM-ALS1 AMD 장착 바 나사와 쿨러를 장착 바에 고정하는 스프링 나사에 최대 0.6 N·m를 안내합니다. 이는 목표 토크가 아니라 넘지 말아야 할 자사 부품의 최대값이며, 다른 브랜드나 다른 나사에 적용할 수 없습니다. 정확한 고정을 원한다면 0.5~0.6 N·m 부근을 안정적으로 설정할 수 있는 저토크 드라이버를 쓰되, 반드시 현재 쿨러의 공식 설명서에 수치가 있을 때만 사용하세요."
        }
      ],
      decision: [
        {
