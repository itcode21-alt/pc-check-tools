  ...
  symptomDetails: {
    ...
    "display-driver-crash": {
      ...
      intro: [
        ...
        "가끔 한 번 발생하는 정도라면 큰 문제가 아닐 수 있지만, 특정 게임이나 작업 중 반복적으로 발생한다면 드라이버 호환성, 오버클럭 불안정, 발열, 전원 공급 부족 중 하나일 가능성이 높습니다.",
        "원인을 좁히려면 오버클럭 여부, 온도, 전원 순서로 하나씩 확인하는 것이 효율적입니다."
      ],
      warnings: [
