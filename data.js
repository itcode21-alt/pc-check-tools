window.SITE_DATA = {
  ...
  symptoms: [
    ...
    },
    {
      ...
      keywords: ["그래픽카드 소음", "고주파 소음", "코일 노이즈", "코일 위스파", "그래픽카드 삐소리", "gpu 소음", "그래픽카드 지지직"],
      causes: [
      ...
      checks: [
        ...
        "소음이 최근 들어 눈에 띄게 커졌거나 성능 저하·화면 이상이 함께 나타난다면, 정상적인 코일 노이즈 범위를 벗어난 것일 수 있으니 제조사 A/S 문의를 고려하세요."
      ],
      ...
      decision: [
        {
          ...
          text: "대부분 정상 범위의 코일 노이즈입니다. 신경 쓰인다면 프레임 제한 기능으로 불필요하게 높은 fps를 줄이는 정도로 충분합니다."
        },
        {
